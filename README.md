...
## Changes
0.1.29: 2018-Dec-09
- Added support for config file /etc/remirror.conf. If it exists, it will be sourced. Currently it may contain the following variables: REMIRROR_PREOPTIONS and REMIRROR_POSTOPTIONS; they can include any remirror options.
